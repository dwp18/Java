...
public class Eg3_5_ComputeTax {
    public static void main (String[] args){
        ...
        System.out.print("(0-single filer, 1-married jointly or qualifying widow(er), 2-married separately, 3-head of houshold)");
        ...
        if (status == 0){
            ...
            if(income <= 8350){
                ...
                tax = 8350 * 0.1 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186745- 104425) * 0.33 + (income - 186745) * 0.35;
            }
        } else if (status == 3){
            if(income <= 11950){
                tax = income * 0.1;
            ...
            System.out.print("You input the wrong filing status number.");
            System.exit(1);
        }
